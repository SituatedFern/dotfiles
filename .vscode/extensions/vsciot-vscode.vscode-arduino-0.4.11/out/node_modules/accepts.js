 ...
 * MIT Licensed
 */var n=Object.create(null);function o(a){if(!(this instanceof o))return new o(a);this.request=a}function s(a){var e=n[a];if(void 0!==e)return e;switch(a){case"charset":e=i(195);break;case"encoding":e=i(196);break;case"language":e=i(197);break;case"mediaType":e=i(198);break;default:throw new Error("Cannot find module '"+a+"'")}return n[a]=e,e}a.exports=o,a.exports.Negotiator=o,o.prototype.charset=function(a){var e=this.charsets(a);return e&&e[0]},o.prototype.charsets=function(a){return(0,s("charset").preferredCharsets)(this.request.headers["accept-charset"],a)},o.prototype.encoding=function(a){var e=this.encodings(a);return e&&e[0]},o.prototype.encodings=function(a){return(0,s("encoding").preferredEncodings)(this.request.headers["accept-encoding"],a)},o.prototype.language=function(a){var e=this.languages(a);return e&&e[0]},o.prototype.languages=function(a){return(0,s("language").preferredLanguages)(this.request.headers["accept-language"],a)},o.prototype.mediaType=function(a){var e=this.mediaTypes(a);return e&&e[0]},o.prototype.mediaTypes=function(a){return(0,s("mediaType").preferredMediaTypes)(this.request.headers.accept,a)},o.prototype.preferredCharset=o.prototype.charset,o.prototype.preferredCharsets=o.prototype.charsets,o.prototype.preferredEncoding=o.prototype.encoding,o.prototype.preferredEncodings=o.prototype.encodings,o.prototype.preferredLanguage=o.prototype.language,o.prototype.preferredLanguages=o.prototype.languages,o.prototype.preferredMediaType=o.prototype.mediaType,o.prototype.preferredMediaTypes=o.prototype.mediaTypes},195:function(a,e,i){"use strict";a.exports=c,a.exports.preferredCharsets=c;var n=/^\s*([^\s;]+)\s*(?:;(.*))?$/;function o(a,e){var i=n.exec(a);if(!i)return null;var o=i[1],s=1;if(i[2])for(var c=i[2].split(";"),p=0;p<c.length;p++){var t=c[p].trim().split("=");if("q"===t[0]){s=parseFloat(t[1]);break}}return{charset:o,q:s,i:e}}function s(a,e,i){var n=0;if(e.charset.toLowerCase()===a.toLowerCase())n|=1;else if("*"!==e.charset)return null;return{i:i,o:e.i,q:e.q,s:n}}function c(a,e){var i=function(a){for(var e=a.split(","),i=0,n=0;i<e.length;i++){var s=o(e[i].trim(),i);s&&(e[n++]=s)}return e.length=n,e}(void 0===a?"*":a||"");if(!e)return i.filter(r).sort(p).map(t);var n=e.map((function(a,e){return function(a,e,i){for(var n={o:-1,q:0,s:0},o=0;o<e.length;o++){var c=s(a,e[o],i);c&&(n.s-c.s||n.q-c.q||n.o-c.o)<0&&(n=c)}return n}(a,i,e)}));return n.filter(r).sort(p).map((function(a){return e[n.indexOf(a)]}))}function p(a,e){return e.q-a.q||e.s-a.s||a.o-e.o||a.i-e.i||0}function t(a){return a.charset}function r(a){return a.q>0}},196:function(a,e,i){"use strict";a.exports=c,a.exports.preferredEncodings=c;var n=/^\s*([^\s;]+)\s*(?:;(.*))?$/;function o(a,e){var i=n.exec(a);if(!i)return null;var o=i[1],s=1;if(i[2])for(var c=i[2].split(";"),p=0;p<c.length;p++){var t=c[p].trim().split("=");if("q"===t[0]){s=parseFloat(t[1]);break}}return{encoding:o,q:s,i:e}}function s(a,e,i){var n=0;if(e.encoding.toLowerCase()===a.toLowerCase())n|=1;else if("*"!==e.encoding)return null;return{i:i,o:e.i,q:e.q,s:n}}function c(a,e){var i=function(a){for(var e=a.split(","),i=!1,n=1,c=0,p=0;c<e.length;c++){var t=o(e[c].trim(),c);t&&(e[p++]=t,i=i||s("identity",t),n=Math.min(n,t.q||1))}return i||(e[p++]={encoding:"identity",q:n,i:c}),e.length=p,e}(a||"");if(!e)return i.filter(r).sort(p).map(t);var n=e.map((function(a,e){return function(a,e,i){for(var n={o:-1,q:0,s:0},o=0;o<e.length;o++){var c=s(a,e[o],i);c&&(n.s-c.s||n.q-c.q||n.o-c.o)<0&&(n=c)}return n}(a,i,e)}));return n.filter(r).sort(p).map((function(a){return e[n.indexOf(a)]}))}function p(a,e){return e.q-a.q||e.s-a.s||a.o-e.o||a.i-e.i||0}function t(a){return a.encoding}function r(a){return a.q>0}},197:function(a,e,i){"use strict";a.exports=c,a.exports.preferredLanguages=c;var n=/^\s*([^\s\-;]+)(?:-([^\s;]+))?\s*(?:;(.*))?$/;function o(a,e){var i=n.exec(a);if(!i)return null;var o=i[1],s=i[2],c=o;s&&(c+="-"+s);var p=1;if(i[3])for(var t=i[3].split(";"),r=0;r<t.length;r++){var l=t[r].split("=");"q"===l[0]&&(p=parseFloat(l[1]))}return{prefix:o,suffix:s,q:p,i:e,full:c}}function s(a,e,i){var n=o(a);if(!n)return null;var s=0;if(e.full.toLowerCase()===n.full.toLowerCase())s|=4;else if(e.prefix.toLowerCase()===n.full.toLowerCase())s|=2;else if(e.full.toLowerCase()===n.prefix.toLowerCase())s|=1;else if("*"!==e.full)return null;return{i:i,o:e.i,q:e.q,s:s}}function c(a,e){var i=function(a){for(var e=a.split(","),i=0,n=0;i<e.length;i++){var s=o(e[i].trim(),i);s&&(e[n++]=s)}return e.length=n,e}(void 0===a?"*":a||"");if(!e)return i.filter(r).sort(p).map(t);var n=e.map((function(a,e){return function(a,e,i){for(var n={o:-1,q:0,s:0},o=0;o<e.length;o++){var c=s(a,e[o],i);c&&(n.s-c.s||n.q-c.q||n.o-c.o)<0&&(n=c)}return n}(a,i,e)}));return n.filter(r).sort(p).map((function(a){return e[n.indexOf(a)]}))}function p(a,e){return e.q-a.q||e.s-a.s||a.o-e.o||a.i-e.i||0}function t(a){return a.full}function r(a){return a.q>0}},198:function(a,e,i){"use strict";a.exports=p,a.exports.preferredMediaTypes=p;var n=/^\s*([^\s\/;]+)\/([^;\s]+)\s*(?:;(.*))?$/;function o(a){for(var e=function(a){for(var e=a.split(","),i=1,n=0;i<e.length;i++)u(e[n])%2==0?e[++n]=e[i]:e[n]+=","+e[i];return e.length=n+1,e}(a),i=0,n=0;i<e.length;i++){var o=s(e[i].trim(),i);o&&(e[n++]=o)}return e.length=n,e}function s(a,e){var i=n.exec(a);if(!i)return null;var o=Object.create(null),s=1,c=i[2],p=i[1];if(i[3])for(var t=function(a){for(var e=a.split(";"),i=1,n=0;i<e.length;i++)u(e[n])%2==0?e[++n]=e[i]:e[n]+=";"+e[i];e.length=n+1;for(i=0;i<e.length;i++)e[i]=e[i].trim();return e}(i[3]).map(m),r=0;r<t.length;r++){var l=t[r],d=l[0].toLowerCase(),x=l[1],v=x&&'"'===x[0]&&'"'===x[x.length-1]?x.substr(1,x.length-2):x;if("q"===d){s=parseFloat(v);break}o[d]=v}return{type:p,subtype:c,params:o,q:s,i:e}}function c(a,e,i){var n=s(a),o=0;if(!n)return null;if(e.type.toLowerCase()==n.type.toLowerCase())o|=4;else if("*"!=e.type)return null;if(e.subtype.toLowerCase()==n.subtype.toLowerCase())o|=2;else if("*"!=e.subtype)return null;var c=Object.keys(e.params);if(c.length>0){if(!c.every((function(a){return"*"==e.params[a]||(e.params[a]||"").toLowerCase()==(n.params[a]||"").toLowerCase()})))return null;o|=1}return{i:i,o:e.i,q:e.q,s:o}}function p(a,e){var i=o(void 0===a?"*/*":a||"");if(!e)return i.filter(l).sort(t).map(r);var n=e.map((function(a,e){return function(a,e,i){for(var n={o:-1,q:0,s:0},o=0;o<e.length;o++){var s=c(a,e[o],i);s&&(n.s-s.s||n.q-s.q||n.o-s.o)<0&&(n=s)}return n}(a,i,e)}));return n.filter(l).sort(t).map((function(a){return e[n.indexOf(a)]}))}function t(a,e){return e.q-a.q||e.s-a.s||a.o-e.o||a.i-e.i||0}function r(a){return a.type+"/"+a.subtype}function l(a){return a.q>0}function u(a){for(var e=0,i=0;-1!==(i=a.indexOf('"',i));)e++,i++;return e}function m(a){var e,i,n=a.indexOf("=");return-1===n?e=a:(e=a.substr(0,n),i=a.substr(n+1)),[e,i]}},2:function(a,e){a.exports=require("path")},279:function(a,e,i){"use strict";
/*!
 * accepts
 * Copyright(c) 2014 Jonathan Ong
 * Copyright(c) 2015 Douglas Christopher Wilson
 * MIT Licensed
 */var n=i(194),o=i(95);function s(a){if(!(this instanceof s))return new s(a);this.headers=a.headers,this.negotiator=new n(a)}function c(a){return-1===a.indexOf("/")?o.lookup(a):a}function p(a){return"string"==typeof a}a.exports=s,s.prototype.type=s.prototype.types=function(a){var e=a;if(e&&!Array.isArray(e)){e=new Array(arguments.length);for(var i=0;i<e.length;i++)e[i]=arguments[i]}if(!e||0===e.length)return this.negotiator.mediaTypes();if(!this.headers.accept)return e[0];var n=e.map(c),o=this.negotiator.mediaTypes(n.filter(p)),s=o[0];return!!s&&e[n.indexOf(s)]},s.prototype.encoding=s.prototype.encodings=function(a){var e=a;if(e&&!Array.isArray(e)){e=new Array(arguments.length);for(var i=0;i<e.length;i++)e[i]=arguments[i]}return e&&0!==e.length?this.negotiator.encodings(e)[0]||!1:this.negotiator.encodings()},s.prototype.charset=s.prototype.charsets=function(a){var e=a;if(e&&!Array.isArray(e)){e=new Array(arguments.length);for(var i=0;i<e.length;i++)e[i]=arguments[i]}return e&&0!==e.length?this.negotiator.charsets(e)[0]||!1:this.negotiator.charsets()},s.prototype.lang=s.prototype.langs=s.prototype.language=s.prototype.languages=function(a){var e=a;if(e&&!Array.isArray(e)){e=new Array(arguments.length);for(var i=0;i<e.length;i++)e[i]=arguments[i]}return e&&0!==e.length?this.negotiator.languages(e)[0]||!1:this.negotiator.languages()}},73:function(a,e,i){
/*!
 * mime-db
 * Copyright(c) 2014 Jonathan Ong
 * MIT Licensed
...
// SIG // /Xmfwb1tbWrJUnMTDXpQzTGCFWUwghVhAgEBMIGVMH4x
...
// SIG // AQkEMSIEIPPU1PZxTFCuLfpnSwzgP4q7NkiqCWmNeqob
// SIG // EDlRfE7tMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkA
// SIG // YwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jv
// SIG // c29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggE