module.exports=function(t){var e={};function r(n){if(e[n])return e[n].exports;var i=e[n]={i:n,l:!1,exports:{}};return t[n].call(i.exports,i,i.exports,r),i.l=!0,i.exports}return r.m=t,r.c=e,r.d=function(t,e,n){r.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:n})},r.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},r.t=function(t,e){if(1&e&&(t=r(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var n=Object.create(null);if(r.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var i in t)r.d(n,i,function(e){return t[e]}.bind(null,i));return n},r.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return r.d(e,"a",e),e},r.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},r.p="",r(r.s=199)}({0:function(t,e){t.exports=require("util")},1:function(t,e){t.exports=require("fs")},149:function(t,e){function r(){this.pending=0,this.max=1/0,this.listeners=[],this.waiting=[],this.error=null}function n(t){t.pending+=1;var e=!1;return function(n){if(e)throw new Error("callback called twice");if(e=!0,t.error=t.error||n,t.pending-=1,t.waiting.length>0&&t.pending<t.max)i(t,t.waiting.shift());else if(0===t.pending){var o=t.listeners;t.listeners=[],o.forEach(r)}};function r(e){e(t.error)}}function i(t,e){e(n(t))}t.exports=r,r.prototype.go=function(t){this.pending<this.max?i(this,t):this.waiting.push(t)},r.prototype.wait=function(t){0===this.pending?t(this.error):this.listeners.push(t)},r.prototype.hold=function(){return n(this)}},199:function(t,e,r){var n=r(1),i=r(0),o=r(3),s=o.Readable,f=o.Writable,u=o.PassThrough,d=r(149),c=r(5).EventEmitter;function a(t,e){e=e||{},c.call(this),this.fd=t,this.pend=new d,this.pend.max=1,this.refCount=0,this.autoClose=!!e.autoClose}function h(t,e){e=e||{},s.call(this,e),this.context=t,this.context.ref(),this.start=e.start||0,this.endOffset=e.end,this.pos=this.start,this.destroyed=!1}function p(t,e){e=e||{},f.call(this,e),this.context=t,this.context.ref(),this.start=e.start||0,this.endOffset=null==e.end?1/0:+e.end,this.bytesWritten=0,this.pos=this.start,this.destroyed=!1,this.on("finish",this.destroy.bind(this))}function l(t,e){c.call(this),e=e||{},this.refCount=0,this.buffer=t,this.maxChunkSize=e.maxChunkSize||Number.MAX_SAFE_INTEGER}e.createFromBuffer=function(t,e){return new l(t,e)},e.createFromFd=function(t,e){return new a(t,e)},e.BufferSlicer=l,e.FdSlicer=a,i.inherits(a,c),a.prototype.read=function(t,e,r,i,o){var s=this;s.pend.go((function(f){n.read(s.fd,t,e,r,i,(function(t,e,r){f(),o(t,e,r)}))}))},a.prototype.write=function(t,e,r,i,o){var s=this;s.pend.go((function(f){n.write(s.fd,t,e,r,i,(function(t,e,r){f(),o(t,e,r)}))}))},a.prototype.createReadStream=function(t){return new h(this,t)},a.prototype.createWriteStream=function(t){return new p(this,t)},a.prototype.ref=function(){this.refCount+=1},a.prototype.unref=function(){var t=this;if(t.refCount-=1,!(t.refCount>0)){if(t.refCount<0)throw new Error("invalid unref");t.autoClose&&n.close(t.fd,(function(e){e?t.emit("error",e):t.emit("close")}))}},i.inherits(h,s),h.prototype._read=function(t){var e=this;if(!e.destroyed){var r=Math.min(e._readableState.highWaterMark,t);if(null!=e.endOffset&&(r=Math.min(r,e.endOffset-e.pos)),r<=0)return e.destroyed=!0,e.push(null),void e.context.unref();e.context.pend.go((function(t){if(e.destroyed)return t();var i=new Buffer(r);n.read(e.context.fd,i,0,r,e.pos,(function(r,n){r?e.destroy(r):0===n?(e.destroyed=!0,e.push(null),e.context.unref()):(e.pos+=n,e.push(i.slice(0,n))),t()}))}))}},h.prototype.destroy=function(t){this.destroyed||(t=t||new Error("stream destroyed"),this.destroyed=!0,this.emit("error",t),this.context.unref())},i.inherits(p,f),p.prototype._write=function(t,e,r){var i=this;if(!i.destroyed){if(i.pos+t.length>i.endOffset){var o=new Error("maximum file length exceeded");return o.code="ETOOBIG",i.destroy(),void r(o)}i.context.pend.go((function(e){if(i.destroyed)return e();n.write(i.context.fd,t,0,t.length,i.pos,(function(t,n){t?(i.destroy(),e(),r(t)):(i.bytesWritten+=n,i.pos+=n,i.emit("progress"),e(),r())}))}))}},p.prototype.destroy=function(){this.destroyed||(this.destroyed=!0,this.context.unref())},i.inherits(l,c),l.prototype.read=function(t,e,r,n,i){var o=n+r,s=o-this.buffer.length,f=s>0?s:r;this.buffer.copy(t,e,n,o),setImmediate((function(){i(null,f)}))},l.prototype.write=function(t,e,r,n,i){t.copy(this.buffer,n,e,e+r),setImmediate((function(){i(null,r,t)}))},l.prototype.createReadStream=function(t){var e=new u(t=t||{});e.destroyed=!1,e.start=t.start||0,e.endOffset=t.end,e.pos=e.endOffset||this.buffer.length;for(var r=this.buffer.slice(e.start,e.pos),n=0;;){var i=n+this.maxChunkSize;if(i>=r.length){n<r.length&&e.write(r.slice(n,r.length));break}e.write(r.slice(n,i)),n=i}return e.end(),e.destroy=function(){e.destroyed=!0},e},l.prototype.createWriteStream=function(t){var e=this,r=new f(t=t||{});return r.start=t.start||0,r.endOffset=null==t.end?this.buffer.length:+t.end,r.bytesWritten=0,r.pos=r.start,r.destroyed=!1,r._write=function(t,n,i){if(!r.destroyed){var o=r.pos+t.length;if(o>r.endOffset){var s=new Error("maximum file length exceeded");return s.code="ETOOBIG",r.destroyed=!0,void i(s)}t.copy(e.buffer,r.pos,0,t.length),r.bytesWritten+=t.length,r.pos=o,r.emit("progress"),i()}},r.destroy=function(){r.destroyed=!0},r},l.prototype.ref=function(){this.refCount+=1},l.prototype.unref=function(){if(this.refCount-=1,this.refCount<0)throw new Error("invalid unref")}},3:function(t,e){t.exports=require("stream")},5:function(t,e){t.exports=require("events")}});
// SIG // Begin signature block
// SIG // MIIjpQYJKoZIhvcNAQcCoIIjljCCI5ICAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // 7VqFyCgePFktgzJoHDHBfQPoRPE7Ibsv2Fs5mHBepdmg
...
// SIG // AQkEMSIEILNemfs4qugdrr/ICguqu6j0kAq92aWZaHEv
// SIG // SkgulADOMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkA
// SIG // YwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jv
// SIG // c29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggE